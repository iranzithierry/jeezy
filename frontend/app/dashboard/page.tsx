            ...
            <div className="grid gap-6 max-w-6xl w-full mx-auto">
                ...
                <div className="border rounded-lg overflow-hidden grid gap-4 lg:gap-px lg:bg-gray-100">
                    ...
                    <div className='p-4'>
                        ...
                        <p className='max-w-[600px] mt-2 text-gray-500 text-sm/relaxed dark:text-gray-600 text-center'>
                        ...
                        <PopoverContent className="w-[400px] p-4">
                            <div className="grid gap-4">
                                ...
                                <div className="grid gap-2">
                                    <LinkButton linkTo='/dashboard/deploy' variant="outline">Deploy a Github Repo</LinkButton>
                                </div>
                            </div>
                        </PopoverContent>
                    </Popover>
